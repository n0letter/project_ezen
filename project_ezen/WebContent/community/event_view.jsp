...
<!-- 현재 위치 표시 -->
  ...
  <div class="review_view_wrap">
    ...
    <div class="review_write_title">
  	  <h4><small class="service_small">▌</small>이벤트 상세보기</h4>
  	</div>
    ...
    <div class="review_view_content">
      ...
      <table class="review_view_table">
	    <tr>	    
		  ...
		  <td colspan="3" class="review_view_td01">${dto.event_title}</td>	
		  <th class="review_view_th02">작성자</th>
		  <td class="review_view_td02">${dto.event_name}</td>	  
		</tr>
		<tr>	      
		  <th class="review_view_th01">작성일</th>
		  <fmt:formatDate value="${dto.event_date}" pattern="yyyy-MM-dd HH:mm:ss" var="reg" />
		  <td class="review_view_td03">${reg}</td>	
		  <th class="review_view_th03">조회수</th>
		  <td class="review_view_td04">${dto.event_hit}</td>	
		  <td colspan="2" class="review_view_tdN"></td> 
		</tr>
		<tr class="review_view_bottom">
		  <td colspan="6">
		    <div class="reContent" style="white-space:pre;">
		      <span>${dto.event_content}</span>
		    </div> 
		  </td>
        </tr>
	  </table>
      ...
      <div class="notice_list_wrap"> 
		  ...
		  onClick="location.href='/project_ezen/community/event.do?page=1'"/>
 	  </div>	
  </div>
  <!-- back-to-top -->
