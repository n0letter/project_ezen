...
<!-- 현재 위치 표시 -->
 ...
 <form method="post" name="noticeModify" action="noticeModify.do" >  
 ...
 <div class="board00"></div>
  <div class="board">
      ...
      <table width="100%">
        <tbody>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="board-right">
                      ...
                      value="${dto.notice_title }" name="notice_title">
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="board-right">
                      ...
                      value="${dto.notice_name }" name="notice_name">
                  ...
                  <tr>
                    ...
                    <td class="board-right">
                      ...
                      value="${dto.notice_date }" name="notice_date">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="ta-right">
                      <textarea name="notice_content" class="ckeditor" cols="52" >${dto.notice_content }
                      </textarea>
                    </td>
                  </tr>
                </tbody>
         ...
         <div class="nbuttons">
          ...
          <input class="nwritebutton" type="button" value="삭제" onclick="deletecheck()"/>
          <!-- </a> -->	
          <input type="button" class="nwritesub02" value="목록" onClick="location.href='admin_notice.do?page=1'"/>
        </div>
 </div>
 </div>
  </div>
	...
	<form name="frmM" method="post" target="HiddenFrame">
		<input type="hidden" name="notice_delete">
	</form>
</div>
...
function deletecheck() {
	frmM.notice_delete.value = noticeModify.notice_idx.value;
	var a = confirm("글을 삭제하시겠습니까?")
	if(a == true){
		frmM.action = "noticeDelete.do"
		frmM.submit();
	} else {
